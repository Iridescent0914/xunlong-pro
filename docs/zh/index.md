...
```bash
# 生成研究报告
python SmartFin.py report "2025年人工智能行业趋势分析"

# 生成小说
python SmartFin.py fiction "一个关于时间旅行的科幻故事" --chapters 10

# 生成PPT
python SmartFin.py ppt "2025年产品发布会" --slides 15

# 基于已有资料生成报告
python SmartFin.py report "AI创业商业计划书" --input-file ./docs/plan.docx
```

## 为什么选择SmartFin？

SmartFin将大语言模型的强大能力与精心设计的多智能体架构相结合，自动化完成从研究规划到内容生成、格式导出的全流程。
...
<div style="text-align: center; margin-top: 48px;">
  ...
  <p>Copyright © 2025-present SmartFin Team</p>
</div>
