...
整体风格: {style}"""
    ...
    def _wrap_slide_html(
        ...
        """
        slide_number = slide_meta['slide_number']
        total_slides = ppt_metadata.get('total_slides', len(ppt_metadata.get('slides', [])))
        prev_slide = slide_meta.get('prev')
        next_slide = slide_meta.get('next')

        if prev_slide:
            prev_button = (
                f"""<button class="nav-btn" onclick="window.location.href='{prev_slide}'">"""
        ...
        if next_slide:
            next_button = (
                f"""<button class="nav-btn" onclick="window.location.href='{next_slide}'">"""
