...
class LLMManager:
    ...
    def _create_default_configs(self):
        ...
        default_model = self._get_default_model(best_provider)
        ...
        for config_name in [
            ...
            self.configs[config_name] = create_llm_config(
                ...
                else (0.3 if config_name == "query_optimizer" else 0.5 if config_name == "search_analyzer" else default_temperature),
                max_tokens=default_max_tokens
                if config_name in {"default", "content_synthesizer"}
                else (2000 if config_name == "query_optimizer" else 4000),
            )
            logger.info(
                "llm_config: name={}, provider={}, model={}, base_url={}, api_key={}",
                config_name,
                best_provider,
                default_model,
                base_url,
